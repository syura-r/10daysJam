...
public:
	...
	void DrawSprite(const std::string& name,const XMFLOAT2& position,const float& rotation = 0.0f,const XMFLOAT2& scale = { 1.0f,1.0f },const XMFLOAT4& color = { 1,1,1,1 },const XMFLOAT2& anchorpoint = {0.5f,0.5f}, BLENDTYPE type = ALPHA);
