...
void UnionPartsMotion::Initialize()
{
...
bool UnionPartsMotion::RiseObjects()
{
	//各文字オブジェクト順に上へ移動
...
bool UnionPartsMotion::UnionObjects()
{
...
bool UnionPartsMotion::poseObjects()
{
