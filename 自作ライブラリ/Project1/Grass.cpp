...
void Grass::Draw()
{
	...
	cmdList->SetGraphicsRootConstantBufferView(4, constCameraBuff->GetGPUVirtualAddress());
	cmdList->SetGraphicsRootDescriptorTable(3, Texture::GetGpuDescHandleSRV("shadowMap"));  //ヒープの先頭が定数バッファ
